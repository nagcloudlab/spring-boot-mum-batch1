...
public class ImpsTransferService implements TransferService {
    ...
    public void transfer(String fromAccountNumber, String toAccountNumber, double amount) {
        ...
        // toggle to 'true' to simulate failure and observe @Transactional rollback
        boolean simulateFailure = false;
        if (simulateFailure) {
            throw new RuntimeException("Simulated failure — debit done, credit pending. Will @Transactional rollback?");
        }
