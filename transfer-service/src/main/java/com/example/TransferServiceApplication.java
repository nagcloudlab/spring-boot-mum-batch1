...
public class TransferServiceApplication {
	...
	private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger("txr-service");
	...
	public static void main(String[] args) {
		...
		context = SpringApplication.run(TransferServiceApplication.class, args);// Auto..
